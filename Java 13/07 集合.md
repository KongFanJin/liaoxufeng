...
注意到这个`toArray(T[])`方法的泛型参数``并不是`List`接口定义的泛型参数``，所以，我们实际上可以传入其他类型的数组，例如我们传入`Number`类型的数组，返回的仍然是`Number`类型：
...
下载练习：[找出缺失的数字](https://gitee.com/liaoxuefeng/learn-java/raw/master/practices/Java教程/70.集合.1255943629175808/20.使用List.1265112034799552/coll-list.zip) （推荐使用[IDE练习插件](https://www.liaoxuefeng.com/wiki/1252599548343744/1266092093733664)快速下载）
...
下载练习：[覆写equals方法](https://gitee.com/liaoxuefeng/learn-java/raw/master/practices/Java教程/70.集合.1255943629175808/30.编写equals方法.1265116446975264/coll-equals.zip) （推荐使用[IDE练习插件](https://www.liaoxuefeng.com/wiki/1252599548343744/1266092093733664)快速下载）
...
下载练习：[find-student-score](https://gitee.com/liaoxuefeng/learn-java/raw/master/practices/Java教程/70.集合.1255943629175808/40.使用Map.1265118019954528/coll-map.zip) （推荐使用[IDE练习插件](https://www.liaoxuefeng.com/wiki/1252599548343744/1266092093733664)快速下载）
...
下载练习：[Stack练习](https://gitee.com/liaoxuefeng/learn-java/raw/master/practices/Java教程/70.集合.1255943629175808/120.使用Stack.1265121668997888/coll-stack.zip) （推荐使用[IDE练习插件](https://www.liaoxuefeng.com/wiki/1252599548343744/1266092093733664)快速下载）
